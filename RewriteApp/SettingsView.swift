...
struct SettingsView: View {
    ...
    private var generalSection: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            desc("Clipboard history starts automatically and stays only on this Mac. It records normal text copies, never concealed or transient pasteboard items. Turn it off here to stop future capture.")
